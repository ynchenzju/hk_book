...
start_day = 20230501
end_day = 20231001
select_days = set([20230623, 20230624])
select_days = set([])
...
def filter_time(region, region_quota, key):
    name_map = {"quotaR": "一般服务时段(办理身份证使用)", "quotaK": "延长服务时段(身份证旧换新使用)"}
    valid_date = []
...
json_temp = {"appToken":"AT_7FOnGTv0fw0BSrAGDkVeEl2hJEjcBwwB",
        ...
        "content": '办理网址:https://webapp.es2.immd.gov.hk/smartics2-client/QueueIt.html?applicationId=579&language=zh&country=HK\n========================\n' + result_str}
